...
(after! rustic
  (setq rustic-lsp-server 'rust-analyzer
        rustic-clippy-arguments ["--all-features", " --", "-D", "warnings", "-D", "rust-2018-idioms"]
...
(package! gptel
  ...
  :pin "a61fda466171113684de5a6a154c2a8bf5a127c3")
#+end_src
...
(use-package! gptel
  ...
  (setq-default gptel-model "mistral-large-2402"
