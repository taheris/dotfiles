...
#+begin_src emacs-lisp :tangle packages.el
(package! gptel :pin "fc78b45a78b417c76b32b738f54664b4fe87c220")
#+end_src
...
(after! gptel
  (let* ((gptel-anthropic (gptel-make-anthropic "Anthropic"
         ...
         (gptel-cerebras (gptel-make-openai "Cerebras"
                           ...
                           :stream t
                           :key #'gptel-api-key-from-auth-source
                           :models '(qwen-3-235b-a22b qwen-3-32b llama-4-scout-17b-16e-instruct)))
...
(use-package! aidermacs
  ...
  (setq aidermacs-backend 'vterm
        aidermacs-default-model "cerebrus/qwen-3-235b-a22b"
