...
(package! org-srs
  ...
  :pin "199c37ea027ddb4df375def841dfdc5c523e5742")
#+end_src
...
#+begin_src emacs-lisp :tangle packages.el
(package! gptel :pin "3fe5e08ddd8b1bc6f1eee8a9c6548bf7a029f55e")
#+end_src
...
(after! gptel
  (let* ((gptel-anthropic (gptel-make-anthropic "Anthropic"
         ...
         (gptel-cerebras (gptel-make-openai "Cerebras"
                           ...
                           :stream t
                           :key #'gptel-api-key-from-auth-source
                           :models '(qwen-3-coder-480b qwen-3-235b-a22b-instruct-2507 qwen-3-235b-a22b-thinking-2507)))
...
(use-package! aidermacs
  ...
  (setq aidermacs-backend 'vterm
        aidermacs-default-model "cerebrus/qwen-3-coder-480b"
        aidermacs-use-architect-mode t
        aidermacs-architect-model "ChatGPT/gpt-5"))
#+end_src
